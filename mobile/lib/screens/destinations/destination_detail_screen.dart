              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      destination.name,
                      style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: AppColors.textStrong),
                      maxLines: 1,
                  ...
                  children: [
                    ...
                    if (destination.images.isNotEmpty)
                      ...
                      Container(
                        ...
                        child: const Center(child: Icon(FluentIcons.photo2, color: AppColors.textFaint, size: 48)),
                      ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(destination.name, style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: AppColors.textStrong)),
                              ),
