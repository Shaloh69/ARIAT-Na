                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text('Where would you like to go?', style: TextStyle(fontSize: 14, color: AppColors.textMuted))
                  ...
                  if (destination.address != null)
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(destination.address!, style: const TextStyle(fontSize: 12, color: AppColors.textMuted), maxLines: 1, overflow: TextOverflow.ellipsis),
                        ),
                      ],
                    ),
