...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (mounted) AppToast.success(context, 'Welcome back!');
    } catch (e) {
                ...
                Row(
                  ...
                  children: [
                    ...
                    HyperlinkButton(
                      ...
                      child: const Text('Sign Up', style: TextStyle(color: AppColors.red400, fontSize: 13, fontWeight: FontWeight.w600)),
                    ),
                  ],
