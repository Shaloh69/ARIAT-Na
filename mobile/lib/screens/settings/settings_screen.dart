              ...
              GlassCard(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        const Icon(FluentIcons.server, size: 16, color: AppColors.red400),
                        const SizedBox(width: 8),
                        const Text('Server Connection', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.textStrong)),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        Button(
                          onPressed: () {
                            _urlController.text = AuthService.defaultBaseUrl;
                          },
                          style: ButtonStyle(
                            shape: WidgetStateProperty.all(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),
              ...
              GlassCard(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        const Icon(FluentIcons.info, size: 16, color: AppColors.blue),
                        const SizedBox(width: 8),
                        const Text('About', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.textStrong)),
                      ],
                    ),
                    const SizedBox(height: 14),
