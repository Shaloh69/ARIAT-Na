...
export const getActiveUsers = async (req: AuthRequest, res: Response): Promise<void> => {
...
export const deleteUser = async (req: AuthRequest, res: Response): Promise<void> => {
  ...
  logger.info(`[ADMIN] User deleted: ${user.email} (${id}) by admin ${req.user?.id}`);

  res.json({ success: true, message: `User ${user.full_name} deleted successfully` });
};
