...
type Phase = "trying" | "slow" | "no-app" | "opened";
...
export default function OpenPage() {
  ...
  // Parse token immediately from URLSearchParams — router.query is async after hydration.
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    // After 5 s — show "server still waking up" state
    const slowTimer = setTimeout(() => {
      setPhase("slow");
    }, 5000);

    // After 12 s — give up and show download screen
        ...
        <div className="relative z-10 w-full max-w-sm flex flex-col items-center gap-8 text-center">
              ...
              <div>
                ...
                {phase === "slow" ? (
                  <p className="text-amber-400 text-sm mt-1">
                    Server is waking up — this may take a few more seconds.
                  </p>
                ) : (
          ...
          {phase === "opened" && (
            <div>
              ...
              <p className="text-slate-400 text-sm mt-1">
                Your itinerary is loading in AIRAT-NA.
              </p>
            </div>
          )}
            ...
            <>
              <div>
                ...
                <p className="text-slate-400 text-sm mt-2">
                  Download AIRAT-NA first, then scan the kiosk QR code again to
                  open your itinerary.
                </p>
              </div>
              ...
              <div className="w-full rounded-xl bg-amber-500/10 border border-amber-500/20 px-4 py-3 text-xs text-amber-300/80 text-left space-y-1">
                ...
                <p>
                  Open the app → log in with the account you created at the
                  kiosk → your itinerary will be in the{" "}
                  <strong>Trips</strong> tab.
                </p>
              </div>
